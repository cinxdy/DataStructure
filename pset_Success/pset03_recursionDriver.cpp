...
* assistance in the completion of this assignment. Signed: 신지영
*
* To build this program:
*  g++ recursionDriver.cpp recursion.cpp binsearch.cpp quicksort.cpp -I../../include -L../../lib -lnowic -o recursion
*
* History:
* 2018/02/10	Created
...
int main(int argc, char *argv[]) {
	...
	while(1) {
		...
		case 8:
			...
			cout << "\tcount8(99899) = 1\n";
			while (1) {
				N = GetInt("\tEnter a number to compute count 8(0 to quit): ");
				if (N <= 0) break;
		...
		case 9:
			...
			while (1) {
				int base = GetInt("\tEnter a number to compute power of base(0 to quit): ");
				if (base <= 0) break;
				N = GetInt("\tEnter a number to compute power of n(0 to quit): ");
				if (N <= 0) break;
